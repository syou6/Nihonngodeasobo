...
const WORDS = [
  ...
  { word: '大丈夫', reading: 'だいじょうぶ', en: "its OK", p: 3 },
  { word: '元気', reading: 'げんき', en: "energetic / well", p: 1 },
  { word: '学校', reading: 'がっこう', en: "school", p: 0 },
  { word: '仕事', reading: 'しごと', en: "work", p: 0 },
  { word: '時間', reading: 'じかん', en: "time", p: 0 },
  { word: '名前', reading: 'なまえ', en: "name", p: 0 },
  { word: '家族', reading: 'かぞく', en: "family", p: 1 },
  { word: '天気', reading: 'てんき', en: "weather", p: 1 },
  { word: '電車', reading: 'でんしゃ', en: "train", p: 0 },
  { word: '携帯', reading: 'けいたい', en: "phone", p: 0 },
  { word: '写真', reading: 'しゃしん', en: "photo", p: 0 },
  { word: '音楽', reading: 'おんがく', en: "music", p: 1 },
  { word: '映画', reading: 'えいが', en: "movie", p: 1 },
  { word: '旅行', reading: 'りょこう', en: "travel", p: 0 },
  { word: '料理', reading: 'りょうり', en: "cooking", p: 1 },
  { word: '野菜', reading: 'やさい', en: "vegetable", p: 0 },
  { word: '果物', reading: 'くだもの', en: "fruit", p: 2 },
  { word: '飲み物', reading: 'のみもの', en: "drink", p: 3 },
  { word: '楽しい', reading: 'たのしい', en: "fun", p: 3 },
  { word: '難しい', reading: 'むずかしい', en: "difficult", p: 4 },
  { word: '簡単', reading: 'かんたん', en: "easy", p: 0 },
  { word: '綺麗', reading: 'きれい', en: "pretty", p: 1 },
  { word: '便利', reading: 'べんり', en: "convenient", p: 1 },
  { word: '大切', reading: 'たいせつ', en: "important", p: 0 },
  { word: '大変', reading: 'たいへん', en: "tough", p: 0 },
  { word: '静か', reading: 'しずか', en: "quiet", p: 1 },
  { word: '京都', reading: 'きょうと', en: "Kyoto", p: 1 },
  { word: '有名', reading: 'ゆうめい', en: "famous", p: 0 },
  { word: '普通', reading: 'ふつう', en: "normal", p: 0 },
  { word: '最近', reading: 'さいきん', en: "recently", p: 0 },
  { word: '世界', reading: 'せかい', en: "world", p: 1 },
  { word: '問題', reading: 'もんだい', en: "problem", p: 0 },
  { word: '質問', reading: 'しつもん', en: "question", p: 0 },
];
